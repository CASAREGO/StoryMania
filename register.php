...
<div class="storymanialogo"><img src="storyfinal.png" alt="Imgender"></div>
...
<form class= "" method="post" action="" autocomplete= "off">
      ...
      <input type="text" name="username" id= "username" size="60" required value=""><br>
          <label for="gender">GENDER</label> 
                    <select name="gender" id="gender" required value="">
      ...
      <input type="text" name="favnum" size="60" required><br> 
